...
class MissionReasoner:
    ...
    Capability selection intentionally belongs to ``MissionDirector``. This
    reasoner keeps only terminal/review/approval interpretation plus a legacy
    pending-step fallback while ``MissionPlan.steps`` is being retired.
    """
