...
from tonmen.tools.base import CapabilitySpec, RiskLevel, ToolRequest
...
class PolicyEngine:
    ...
    def evaluate(self, spec: CapabilitySpec, request: ToolRequest) -> PolicyDecision:
        ...
        if spec.requires_approval or spec.risk >= RiskLevel.VALIDATION:
